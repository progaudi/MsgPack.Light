...
namespace ProGaudi.MsgPack.Light.Tests.SequenceReader
{
    public class Nullable
    {
        ...
        {
            var data = new[] { DataCodes.Nil }.ToMultipleSegments();
        ...
        public void False()
        {
            var data = new[] { DataCodes.False }.ToMultipleSegments();
        ...
        public void True()
        {
            var data = new[] { DataCodes.True }.ToMultipleSegments();
        ...
        {
            MsgPackSerializer.Deserialize<double?>(bytes.ToMultipleSegments(), out var readSize).ShouldBe(value);
        ...
        {
            MsgPackSerializer.Deserialize<float?>(bytes.ToMultipleSegments(), out var readSize).ShouldBe(value);
            readSize.ShouldBe(bytes.Length);
        }
