...
//        }
        ...
        public void ReadEnumAsString(DefaultEnum enumValue)
        {
            ...
            {
                var readOnlySpan = bytes.Memory.Span.Slice(0, wroteSize);
                var enumResult = MsgPackSerializer.Deserialize<DefaultEnum>(readOnlySpan, out var readSize);
                enumResult.ShouldBe(enumValue);
...
//        }
        ...
        public void ReadFlagEnumAsString(FlagEnum enumValue)
        {
            ...
            {
                var readOnlySpan = bytes.Memory.Span.Slice(0, wroteSize);
                var enumResult = MsgPackSerializer.Deserialize<FlagEnum>(readOnlySpan, out var readSize);
                enumResult.ShouldBe(enumValue);
                readSize.ShouldBe(wroteSize);
            }
        }
