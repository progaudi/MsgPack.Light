...
namespace ProGaudi.MsgPack.Light.Tests.Reader
{
    public class DateTimeTest
    {
        ...
        public void TestDateTime()
        {
            ...
            {
                MsgPackSerializer.Deserialize<DateTime>(test.data, out var readSize).ShouldBe(test.value);
        ...
        public void TestDateTimeOffset()
        {
            ...
            foreach (var test in tests)
            {
                MsgPackSerializer.Deserialize<DateTimeOffset>(test.data, out var readSize).ShouldBe(test.value);
                readSize.ShouldBe(test.data.Length);
            }
        }
    }
