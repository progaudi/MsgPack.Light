...
namespace ProGaudi.MsgPack.Light
{
    public class MsgPackContext
    {
        ...
        private readonly Dictionary<Type, IMsgPackConverter> _converters = new Dictionary<Type, IMsgPackConverter>
        {
            ...
            {typeof (float), new NumberConverter()},
            {typeof (double), new NumberConverter()},
            {typeof (byte), new NumberConverter()},
            {typeof (sbyte), new NumberConverter()},
            {typeof (short), new NumberConverter()},
            {typeof (ushort), new NumberConverter()},
            {typeof (int), new NumberConverter()},
            {typeof (uint), new NumberConverter()},
            {typeof (long), new NumberConverter()},
            {typeof (ulong), new NumberConverter()},
